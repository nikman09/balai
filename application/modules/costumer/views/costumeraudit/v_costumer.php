...
<div class="table-responsive">
	...
	<div class="panel panel-primary col-md-12" data-collapsed="0">
		...
		<div class="panel-body">
			<form action="<?php echo base_url() ?>costumer/datacostumer" method="post" class="form-horizontal  validate">
			<div class="row">
				<div class="col-md-6">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<select type="text" class="form-control select2" name="area" required/>
								<option value="">.:Semua Area:.</option>
								<?php 
									foreach($area->result_array() as $row) {
										echo "<option value='".$row['cabang']."' ".($row['cabang']==$cabang?"selected":"").">".$row['cabang']."</option>";
									}
								?>
							</select>
						</div>
