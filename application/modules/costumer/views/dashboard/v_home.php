...
<h3>Dashboard <small>(<?php echo $tahun ?>)</small></h3>
...
<div class="row">
	<div class="col-sm-9 col-xs-6">
		<div class="tile-stats tile-white">
			...
			<div class="num">
				<?php echo $jumlahcostumer ?>
			</div>
			<h3>Number of Customers</h3>
			<p>total jumlah costumer.</p>
		</div>
	</div>
	<div class="col-sm-3 col-xs-6">
		...
		<div class="tile-stats tile-white">
			...
			<div class="num">
				<?php echo $jumlahcabang ?>
			</div>

			<h3>Area </h3>
			<p>total jumlah cabang.</p>
		</div>
...
<div class="row">
	<div class="col-sm-3 col-xs-6">
		...
		<div class="tile-stats tile-white">
			...
			<h3>User</h3>
			<p>total keseluruhan jumlah user.</p>
		</div>
	...
	<div class="col-sm-3 col-xs-6">
		...
		<div class="tile-stats tile-white">
			...
			<div class="num">
				<?php echo $jumlahhelper ?>
			</div>
			<h3>Helper/Promotor</h3>
			<p>total keseluruhan user helper/promotor.</p>
		</div>
	...
	<div class="col-sm-3 col-xs-6">
		...
		<div class="tile-stats tile-white">
			...
			<div class="num">
				<?php echo $jumlahmanager ?>
			</div>
			<h3>Manager/Supervisor</h3>
			<p>total keseluruhan user manager.</p>
		</div>
	...
	<div class="col-sm-3 col-xs-6">
		...
		<div class="tile-stats tile-white">
			...
			<div class="num">
				<?php echo $jumlahaudit ?>
			</div>

			<h3>Audit</h3>
			<p>total user audit.</p>
		</div>
...
<div class="row">
	...
	<div class="col-sm-6">
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<div class="panel-title">TOP 10 Helper/Promotor</div>
