...
<h3>Dashboard <small>(<?php echo $tahun ?> | <?php echo $cabang ?> | <?php echo $username ?>)</small></h3>
...
<div class="row">
	<div class="col-sm-3 col-xs-6">
		...
		<div class="tile-stats tile-red">
			...
			<div class="num">
				<?php echo $jumlahcostumerhelper ?>
			</div>
			<h3>Customers </h3>
			<p>total keseluruhan customers '<?php echo $username ?>'.</p>
		</div>
	...
	<div class="col-sm-3 col-xs-6">
		...
		<div class="tile-stats tile-green">
			...
			<div class="num">
				<?php echo $jumlahcostumerhelpertahun ?>
			</div>
			<h3>Customers this Year</h3>
			<p>total keseluruhan customers '<?php echo $username ?>' tahun ini .</p>
		</div>
	...
	<div class="col-sm-3 col-xs-6">
		...
		<div class="tile-stats tile-aqua">
			...
			<div class="num">
				<?php echo $jumlahcostumerhelperbulan ?>
			</div>
			<h3>Customers this Month</h3>
			<p>total keseluruhan customers '<?php echo $username ?>' bulan ini.</p>
		</div>
	...
	<div class="col-sm-3 col-xs-6">
		...
		<div class="tile-stats tile-blue">
			...
			<div class="num">
				<?php echo $jumlahcostumerhelperhari ?>
			</div>

			<h3>Customers this Day</h3>
			<p>total keseluruhan customers '<?php echo $username ?>' hari ini.</p>
		</div>
	...
	<div class="col-sm-8">
		...
		<div class="panel panel-primary" id="charts_env">
			...
			<div class="panel-heading">
				<div class="panel-title">Number of Customers  '<?php echo $username ?>'</div>
