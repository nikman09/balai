<?php   
	$nama = $this->session->userdata("namaadmin");
?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="sidebar-menu menu2">
		<div class="sidebar-menu-inner">
			<header class="logo-env">
				...
				<div class="logo">
					<a href="index.html">
						<img src="<?php echo base_url() ?>assets/images/logoputih2.png" width="140" style="margin-top:3px" alt="" />
					</a>
				</div>
				<!-- logo collapse icon -->
			...
			<?php 
				switch ($rule) {
					case "Audit" : $this->load->view("template/menu");
					break;
					case "Manager" : $this->load->view("template/menumanager");
					break;
					case "Helper" : $this->load->view("template/menuhelper");
					break;
				}
			?>
	</div>
				...
				<ul class="user-info pull-left pull-none-xsm">
					...
					<li class="profile-info dropdown"><!-- add class "pull-right" if you want to place this from right -->
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<?php echo $nama ?> <br/>
							<small style="color:#7c7c7c"><?php echo $jabatan ?> | <?php echo $cabang ?>  <i class="fa fa-caret-down"></i></small>
							</span>
						</a>
						<ul class="dropdown-menu">
							...
							<li>
								<a href="<?php echo base_url() ?>costumer/login/logout">
