...
<div class="panel-body">
	...
	<form role="form" class="form-horizontal validate"  action="<?php echo base_url() ?>costumer/usertambahmanager"	method="post"  enctype="multipart/form-data" id="form"> 	
		<div class="row">
			<div class="col-md-6">
			...
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<div class="col-lg-8">
							<input type="text" class="form-control" name="cabang" value="<?php echo $this->session->userdata("cabang") ?>" readonly />
					</div>
				</div>
				<div class="form-group">
