...
<div class="table-responsive">
	...
	<a style="margin: 5px 0 10px 0px" href="<?php echo base_url() ?>arsip/berkasusertambah" class="btn  btn-primary">
	...
	<div class="panel panel-primary col-md-12" data-collapsed="0">
			...
			<div class="panel-body">
				<form action="<?php echo base_url() ?>arsip/berkasuser" method="post" class="form-horizontal  validate">
				<div class="row">
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<?php if (isset($id_seksi)) {
									?>
									<select class="form-control" name="id_seksi" id="id_seksi"  disabled/>
