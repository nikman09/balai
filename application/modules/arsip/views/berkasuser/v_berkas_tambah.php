<ol class="breadcrumb bc-3">
	...
	<li>
		<a href="<?php echo base_url() ?>arsip/berkasuser">Tambah</a>
	</li>
	<li class="active">
...
<div class="panel-body">
	...
	<form role="form" class="form-horizontal validate"  action="<?php echo base_url() ?>arsip/berkasusertambah"	method="post"  enctype="multipart/form-data">
	<input type="hidden" name="<?=$csrf['name']?>" value="<?=$csrf['hash']?>">
		<div class="row">
			...
			<div class="form-group">
					...
					<div class="col-lg-9">
						<select class="form-control" name="id_seksi" id="id_seksi"  data-required="true"  data-validate="required" data-message-required="Unit Kerja Harus Diisi" disabled />
						<option value="">.:Pilih Unit Kerja:.</option>
						<?php
							foreach($seksi->result_array() as $row) {
								
								 echo "<option value='".$row['id_seksi']."' ";
								 if ($id_seksi==$row['id_seksi']) echo  "selected";
...
<footer class="panel-footer text-right bg-light lter">
	...
	&nbsp
	<a href="<?php echo base_url('arsip/berkasuser') ?>" class="btn btn-default btn-s-xs">
