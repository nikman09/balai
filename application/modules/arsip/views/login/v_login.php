...
<head>
	...
	<title>Balai Jasa Kontruksi Wilayah V | Login</title>
	...
	<div class="login-container">
		<div class="login-header login-caret" style="padding-top:10px;padding-bottom:20px">
			<div class="login-content">
				...
				<img src="<?php echo base_url() ?>assets/images/pu.png" width="50" style="margin-right:5px;border : 2px solid #fff" alt="" />
					<h2 style="color:#f7f7f7">A R S I P</h2>
					<!--img src="<?php echo base_url() ?>assets/back-end/images/logogadget.png" width="120" alt="" -->
				</a>
				<p class="description" style="color:#f7f7f7">Balai Jasa Konstruksi Wilayah V</p>
		...
		<div class="login-form" >
			<div class="login-content">
				...
				<form method="post" role="form" id="form_login" class="validate" action="<?php echo base_url() ?>arsip/login<?php if (isset($_GET['m'])) echo "?m=".$_GET['m'].""; ?>">
