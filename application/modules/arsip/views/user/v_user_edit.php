...
<form role="form" class="form-horizontal validate"  action="<?php echo base_url() ?>arsip/useredit?username=<?php if (isset($username2)) echo $username2; else echo $data['username']; ?>"	method="post"  enctype="multipart/form-data" id="form"> 	
