	...
	<div class="sidebar-menu menu2">
		<div class="sidebar-menu-inner">
			<header class="logo-env">
				...
				<div class="logo">
					<a href="index.html">
						<img src="<?php echo base_url() ?>assets/images/pu.png" width="40" style="margin-right:5px" alt="" />
						<span style="font-weight:bold;color:#fff;font-size:18px;"> A R S I P </span>
					</a>
				</div>
				<!-- logo collapse icon -->
				...
				<ul class="user-info pull-left pull-none-xsm">
					...
					<li class="profile-info dropdown"><!-- add class "pull-right" if you want to place this from right -->
						...
						<ul class="dropdown-menu">
							...
							<!-- Profile sub-links -->
							<li>
								<a href="<?php echo base_url(); ?>arsip/profil">
									<i class="entypo-user"></i>
									Edit Profile
								</a>
							</li>
							<li>
								<a href="<?php echo base_url() ?>arsip/login/logout">
